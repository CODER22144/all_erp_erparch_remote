...
List<Map<String, dynamic>> flattenWithParentFields(List<dynamic> data) {
    ...
    item.forEach((key, value) {
      if (value is List) {
        ...
        for (var inner in value) {
          Map<String, dynamic> keysPair = {};
          while (isFirst) {
            inner.forEach((key, value) {
              keysPair[key] = key;
            });
            isFirst = false;
            subFields.add(keysPair);
          }
          subFields.add(Map<String, dynamic>.from(inner));
        }
      } else {
...
Map<String, List<dynamic>> groupJson(List<dynamic> list, String key) {
