...
class AddJobWorkOutDetails extends StatefulWidget {
  static String routeName = "/addJobWorkOutDetails";

  const AddJobWorkOutDetails({super.key});
  @override
  AddJobWorkOutDetailsState createState() => AddJobWorkOutDetailsState();
}

class AddJobWorkOutDetailsState extends State<AddJobWorkOutDetails>
    ...
    return Consumer<JobWorkOutProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Job WorkOut Details')),
        body: Center(
          child: Column(
            children: [
              TabBar(
                                      ...
                                      ElevatedButton(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (result.statusCode == 200) {
                                            context
                                                .pushReplacementNamed(AddJobWorkOutDetails.routeName);
