                      ...
                      return DataRow(cells: [
                        ...
                        DataCell(Visibility(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri =
                                  Uri.parse(getRightUrl("${data['drawing']}"));
                        ...
                        DataCell(Visibility(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri =
                                  Uri.parse(getRightUrl("${data['images']}"));
                              if (await canLaunchUrl(uri)) {
                                await launchUrl(uri,
                                    mode: LaunchMode.inAppBrowserView);
                              } else {
                        ...
                        DataCell(Visibility(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri =
                                  Uri.parse(getRightUrl("${data['qcformat']}"));
                              if (await canLaunchUrl(uri)) {
                                await launchUrl(uri,
                                    mode: LaunchMode.inAppBrowserView);
                              } else {
                        ...
                        DataCell(Visibility(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri =
                                  Uri.parse(getRightUrl("${data['fmea']}"));
                              if (await canLaunchUrl(uri)) {
                                await launchUrl(uri,
                                    mode: LaunchMode.inAppBrowserView);
                              } else {
                        ...
                        DataCell(Visibility(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri =
                                  Uri.parse(getRightUrl("${data['pfd']}"));
                              if (await canLaunchUrl(uri)) {
                                await launchUrl(uri,
                                    mode: LaunchMode.inAppBrowserView);
                              } else {
                        ...
                        DataCell(Visibility(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri =
                                  Uri.parse(getRightUrl("${data['ccr']}"));
                              if (await canLaunchUrl(uri)) {
                                await launchUrl(uri,
                                    mode: LaunchMode.inAppBrowserView);
                              } else {
