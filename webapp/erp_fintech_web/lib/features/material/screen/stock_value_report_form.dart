...
import 'package:fintech_new_web/features/material/screen/stock_value_report.dart';
...
class StockValueReportForm extends StatefulWidget {
  static String routeName = "StockValueReportForm";
  const StockValueReportForm({super.key});

  @override
  State<StockValueReportForm> createState() => _StockValueReportFormState();
}

class _StockValueReportFormState extends State<StockValueReportForm> {
  @override
  void initState() {
    super.initState();
    MaterialProvider provider =
    Provider.of<MaterialProvider>(context, listen: false);
    provider.initStockValueReportWidget();
  }
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            context.pushNamed(StockValueReport.routeName);
                          },
                          child: const Text(
                            'Submit',
                            style: TextStyle(
