...
class PurchaseOrderProvider with ChangeNotifier {
  ...
  void initWidget() async {
    ...
    widgetList.clear();
    String jsonData =
        '[{"id":"poDate","name":"Order Date","isMandatory":true,"inputType":"datetime"},{"id":"bpCode","name":"Business Partner","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-business-partner/"},{"id":"whCode","name":"Warehouse","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-warehouse/"},{"id":"transmode","name":"Mode Of Transport","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-trans-mode/","default":1},{"id":"mof","name":"Mode Of Freight","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-mof/","default":"P"},{"id":"validFrom","name":"Valid From","isMandatory":true,"inputType":"datetime"},{"id":"validTo","name":"Valid To","isMandatory":true,"inputType":"datetime"},{"id":"freightAmount","name":"Freight Amount","isMandatory":true,"inputType":"number","default":0},{"id":"insurance","name":"Insurance","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-yesno/","default":"N"},{"id":"insuranceAmount","name":"Insurance Amount","isMandatory":true,"inputType":"number","default":0},{"id":"otherCharges","name":"Other Charges","isMandatory":false,"inputType":"text","maxCharacter":100},{"id":"ocAmount","name":"OC Amount","isMandatory":true,"inputType":"number","default":0},{"id":"carrierName","name":"Carrier Name","isMandatory":false,"inputType":"text","maxCharacter":50},{"id":"pdi","name":"PDI","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-tf/","default":false},{"id":"mtc","name":"MTC","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-tf/","default":false},{"id":"packingList","name":"Packing List","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-tf/","default":false}]';
