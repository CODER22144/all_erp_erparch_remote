...
class GetMaterialSource extends StatefulWidget {
  ...
  final bool delete;
  const GetMaterialSource({super.key, required this.delete});
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: CommonAppbar(title: widget.delete ? "Delete Material Source" : 'Get Material Source')),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                if(widget.delete) {
                                  Map<String, dynamic> response = await provider.getByIdMaterialSource();
                                  _showTablePopup(context, response);
                        ...
                        DataCell(ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if(confirmation) {
                              ...
                              http.StreamedResponse response = await networkService.post("/delete-material-source/", {"msId" : '${data['msId']}'});
                              if(response.statusCode == 204) {
                                context.pushReplacementNamed(GetMaterialSource.routeName, extra: true);
                              }
                            }
                          },
                          child: const Text(
