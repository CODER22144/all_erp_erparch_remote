...
class AccountGroupsReport extends StatefulWidget {
  static String routeName = "AccountGrpReport";

  const AccountGroupsReport({super.key});

  @override
  State<AccountGroupsReport> createState() => _AccountGroupsReportState();
}

class _AccountGroupsReportState extends State<AccountGroupsReport> {
  @override
  void initState() {
        ...
        child: SafeArea(
          ...
          body: SingleChildScrollView(
            ...
            child: SingleChildScrollView(
              ...
              child: provider.acGroups.isNotEmpty
                  ? Column(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: TextField(
                            onChanged: (value) {
                              provider
                                  .search(value, ["AgCode", "agDescription"]);
                            },
                        ...
                        DataTable(
                          ...
                          rows: provider.acGroupSearched.map((data) {
