...
class AddMaterialClassification extends StatefulWidget {
  static String routeName = "/AddMaterialClassification";
  final String? editing;
  const AddMaterialClassification({super.key, this.editing});

  @override
  State<AddMaterialClassification> createState() =>
      _AddMaterialClassificationState();
}

class _AddMaterialClassificationState extends State<AddMaterialClassification> {
  late MaterialClassificationProvider provider;
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            final Uri uri = Uri.parse(
                                "https://docs.google.com/spreadsheets/d/15U06NlW-yVt_T_x7Wye6DXCFHgCRU6yPTxwkeYw_DGQ/edit?usp=sharing");
                                ...
                                if (result.statusCode == 200) {
                                  if (widget.editing == "true") {
                                    ...
                                    context.pushReplacementNamed(
                                        AddMaterialClassification.routeName);
                                  }
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables
                  .requestBody[MaterialClassificationProvider.featureName] =
              jsonData;
        }
      } else {
