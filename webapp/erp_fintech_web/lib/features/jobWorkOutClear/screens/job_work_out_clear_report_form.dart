...
class JobWorkOutClearReportForm extends StatefulWidget {
  static String routeName = "JobWorkOutClearReportForm";
  const JobWorkOutClearReportForm({super.key});

  @override
  State<JobWorkOutClearReportForm> createState() =>
      _JobWorkOutClearReportFormState();
}

class _JobWorkOutClearReportFormState extends State<JobWorkOutClearReportForm> {
  @override
  void initState() {
    super.initState();
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(JobWorkOutClearReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
