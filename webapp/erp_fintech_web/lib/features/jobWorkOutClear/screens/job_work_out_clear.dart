...
class JobWorkOutClear extends StatefulWidget {
  static String routeName = "/jobWorkOutClear";
  const JobWorkOutClear({super.key});

  @override
  State<JobWorkOutClear> createState() => _JobWorkOutClearState();
}

class _JobWorkOutClearState extends State<JobWorkOutClear> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<JobWorkOutClearProvider>(
      ...
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Job Workout Clear')),
