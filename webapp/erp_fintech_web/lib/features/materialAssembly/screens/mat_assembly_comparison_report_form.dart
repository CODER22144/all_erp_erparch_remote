...
import 'mat_assembly_comparison_report.dart';

class MatAssemblyComparisonReportForm extends StatefulWidget {
  static String routeName = "MatAssemblyComparisonReportForm";
  const MatAssemblyComparisonReportForm({super.key});

  @override
  State<MatAssemblyComparisonReportForm> createState() =>
      _MatAssemblyComparisonReportFormState();
}

class _MatAssemblyComparisonReportFormState extends State<MatAssemblyComparisonReportForm> {
  @override
  void initState() {
    super.initState();
    MaterialAssemblyProvider provider =
    Provider.of<MaterialAssemblyProvider>(context, listen: false);
    provider.initComparisonReport();
  }
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(MatAssemblyComparisonReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
