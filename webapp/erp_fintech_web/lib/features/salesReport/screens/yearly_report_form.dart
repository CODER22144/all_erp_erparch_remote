...
class YearlyReportForm extends StatefulWidget {
  static String routeName = "/YearlyReportForm";
  const YearlyReportForm({super.key});

  @override
  State<YearlyReportForm> createState() => _YearlyReportFormState();
}

class _YearlyReportFormState extends State<YearlyReportForm> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<SalesReportProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Yearly Sales Report')),
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            context.pushNamed(YearlyReport.routeName);
                          },
                          child: const Text(
                            'Submit',
                            style: TextStyle(
