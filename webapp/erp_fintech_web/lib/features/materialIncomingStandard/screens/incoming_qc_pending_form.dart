...
class IncomingQcPendingForm extends StatefulWidget {
  static String routeName = "IncomingQcPendingForm";
  const IncomingQcPendingForm({super.key});

  @override
  State<IncomingQcPendingForm> createState() => _IncomingQcPendingFormState();
}

class _IncomingQcPendingFormState extends State<IncomingQcPendingForm> {
  @override
  void initState() {
    super.initState();
    MaterialIncomingStandardProvider provider =
    Provider.of<MaterialIncomingStandardProvider>(context, listen: false);
    provider.initQcPending();
  }
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            context.pushNamed(IncomingQcPending.routeName);
                          },
                          child: const Text(
                            'Submit',
                            style: TextStyle(
