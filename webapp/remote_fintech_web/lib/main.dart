...
import 'package:fintech_new_web/features/bankUpload/provider/bank_test_provider.dart';
...
import 'features/masterCodes/provider/master_provider.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
            create: (BuildContext context) => FinancialYearProvider()),
        ChangeNotifierProvider(
            create: (BuildContext context) => OpeningProvider()),
        ChangeNotifierProvider(
            create: (BuildContext context) => PaymentOutwardProvider()),
        ChangeNotifierProvider(
            create: (BuildContext context) => PaymentInProvider()),
        ChangeNotifierProvider(
            create: (BuildContext context) => QueryProvider()),
        ChangeNotifierProvider(
            create: (BuildContext context) => AccountGroupProvider()),
        ChangeNotifierProvider(
            create: (BuildContext context) => SalesOrderNewProvider()),
        ChangeNotifierProvider(
      ...
      child: MaterialApp.router(
        title: 'Open Office',
        theme: ThemeData(
          colorScheme: ColorScheme.fromSeed(seedColor: HexColor('#f9f9ff')),
