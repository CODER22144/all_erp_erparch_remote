...
import 'package:fintech_new_web/features/acGroups/screens/ac_group_report.dart';
...
import 'package:fintech_new_web/features/auth/screen/add_user.dart';
...
import 'package:fintech_new_web/features/bankUpload/screens/bank_test_screen.dart';
...
import 'package:fintech_new_web/features/bankUpload/screens/claimed_payments.dart';
import 'package:fintech_new_web/features/bankUpload/screens/unclaimed_payment.dart';
...
import 'package:fintech_new_web/features/carrier/screens/carrier_report_form.dart';
...
import 'package:fintech_new_web/features/company/screens/company_info.dart';
import 'package:fintech_new_web/features/company/screens/company_report.dart';
...
import 'package:fintech_new_web/features/dbNote/screens/db_note_pending.dart';
...
import 'package:fintech_new_web/features/expirement/screens/step_forms.dart';
...
import 'package:fintech_new_web/features/financialCreditNote/screens/financial_crnote_pending.dart';
import 'package:fintech_new_web/features/financialCreditNote/screens/financial_crnote_report.dart';
import 'package:fintech_new_web/features/financialCreditNote/screens/financial_crnote_report_form.dart';
import 'package:fintech_new_web/features/financialYear/screens/add_financial_year.dart';
import 'package:fintech_new_web/features/financialYear/screens/financial_year_report.dart';
import 'package:fintech_new_web/features/forms/screens/create_form.dart';
import 'package:fintech_new_web/features/forms/screens/form_report.dart';
...
import 'package:fintech_new_web/features/inwardVoucher/screens/inward_voucher_report.dart';
import 'package:fintech_new_web/features/inwardVoucher/screens/inward_voucher_report_form.dart';
...
import 'package:fintech_new_web/features/ledgerCodes/screen/ledger_report_form.dart';
import 'package:fintech_new_web/features/ledgerCodes/screen/ledger_screens.dart';
...
import 'package:fintech_new_web/features/masterCodes/screens/master_codes.dart';
...
import 'package:fintech_new_web/features/material/screen/material_info.dart';
...
import 'package:fintech_new_web/features/opening/screens/opening_report_form.dart';
...
import 'package:fintech_new_web/features/paymentIn/screens/add_payment_id.dart';
import 'package:fintech_new_web/features/paymentIn/screens/payment_in_form_report.dart';
...
import 'package:fintech_new_web/features/paymentOutward/screens/payment_advance_inw_pending.dart';
import 'package:fintech_new_web/features/paymentOutward/screens/payment_advance_outward_pending.dart';
import 'package:fintech_new_web/features/paymentVoucher/screens/payment_voucher_info.dart';
import 'package:fintech_new_web/features/paymentVoucher/screens/payment_voucher_report.dart';
import 'package:fintech_new_web/features/paymentVoucher/screens/payment_voucher_report_form.dart';
...
import 'package:fintech_new_web/features/receiptVoucher/screens/receipt_voucher_report_form.dart';
import 'package:fintech_new_web/features/reports/screens/trial_balance_report.dart';
import 'package:fintech_new_web/features/reports/screens/trial_balance_report_form.dart';
...
import 'package:fintech_new_web/features/reverseCharge/screens/reverse_charge_report.dart';
...
import 'package:fintech_new_web/features/salesOrderNew/screens/sales_order_new_report_form.dart';
import 'package:fintech_new_web/features/sqlQuery/screens/execute_query.dart';
...
import 'features/auth/screen/add_company.dart';
import 'features/auth/screen/forget_password.dart';
import 'features/auth/screen/login.dart';
import 'features/billReceipt/screen/br_info.dart';
...
import 'features/crNote/screens/cr_note_pending.dart';
...
import 'features/ledgerCodes/screen/ledger_details_page.dart';
...
import 'features/paymentIn/screens/payment_in_info.dart';
import 'features/paymentIn/screens/payment_in_report.dart';
...
import 'features/paymentOutward/screens/payment_outward_form_report.dart';
import 'features/paymentOutward/screens/payment_outward_info.dart';
import 'features/paymentOutward/screens/payment_outward_report.dart';
...
import 'features/receiptVoucher/screens/receipt_voucher_report.dart';
import 'features/resources/screens/get_resources.dart';
import 'features/reverseCharge/screens/rcm_info.dart';
...
import 'features/salesOrderNew/screens/sales_order_new_report.dart';
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: <RouteBase>[
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: OrgManagement.routeName,
                name: OrgManagement.routeName,
                builder: (context, state) {
                  return OrgManagement(usrDetails: state.uri.queryParameters['usrDetails'] ?? "");
                }),
            GoRoute(
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: CompanyReport.routeName,
                name: CompanyReport.routeName,
                builder: (context, state) {
                  return const CompanyReport();
                }),
            GoRoute(
                path: CompanyInfo.routeName,
                name: CompanyInfo.routeName,
                builder: (context, state) {
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: BrInfo.routeName,
                name: BrInfo.routeName,
                builder: (context, state) {
                  return const BrInfo();
                }),
            GoRoute(
          ...
          routes: [
            GoRoute(
              ...
              builder: (context, state) {
                ...
                return GetLedgerCodes(delete: delete);
              },
            ),
            GoRoute(
            ...
            GoRoute(
              path: LedgerReportForm.routeName,
              name: LedgerReportForm.routeName,
              builder: (context, state) {
                return const LedgerReportForm();
              },
            ),

            GoRoute(
              path: LedgerScreens.routeName,
              name: LedgerScreens.routeName,
              builder: (context, state) {
                return const LedgerScreens();
              },
            ),
          ]),
      GoRoute(
          ...
          routes: [
            GoRoute(
              path: MaterialInfo.routeName,
              name: MaterialInfo.routeName,
              builder: (context, state) {
                return const MaterialInfo();
              },
            ),
            GoRoute(
      ...
      GoRoute(
          ...
          routes: [
            ...
            GoRoute(
                path: InwardVoucherReportForm.routeName,
                name: InwardVoucherReportForm.routeName,
                builder: (context, state) {
                  return const InwardVoucherReportForm();
                }),
            GoRoute(
                path: InwardVoucherReport.routeName,
                name: InwardVoucherReport.routeName,
                builder: (context, state) {
                  return const InwardVoucherReport();
                }),
          ]),
      GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) {
            return InwardDetails(
                brDetails: state.uri.queryParameters['brDetails'] ?? "");
          }),
      GoRoute(
          path: CreateFinancialCrnote.routeName,
          name: CreateFinancialCrnote.routeName,
          builder: (context, state) {
            return CreateFinancialCrnote(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: FinancialCrnotePending.routeName,
                name: FinancialCrnotePending.routeName,
                builder: (context, state) {
                  return const FinancialCrnotePending();
                }),
            GoRoute(
                path: FinancialCrnoteInfo.routeName,
                name: FinancialCrnoteInfo.routeName,
                builder: (context, state) {
                  return const FinancialCrnoteInfo();
                }),
            GoRoute(
                path: FinancialCrnoteReportForm.routeName,
                name: FinancialCrnoteReportForm.routeName,
                builder: (context, state) {
                  return const FinancialCrnoteReportForm();
                }),
            GoRoute(
                path: FinancialCrnoteReport.routeName,
                name: FinancialCrnoteReport.routeName,
                builder: (context, state) {
                  return const FinancialCrnoteReport();
                }),
          ]),
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: ReceiptVoucherInfo.routeName,
                name: ReceiptVoucherInfo.routeName,
                builder: (context, state) {
                  return const ReceiptVoucherInfo();
                }),
            GoRoute(
                path: ReceiptVoucherReportForm.routeName,
                name: ReceiptVoucherReportForm.routeName,
                builder: (context, state) {
                  return const ReceiptVoucherReportForm();
                }),
            GoRoute(
                path: ReceiptVoucherReport.routeName,
                name: ReceiptVoucherReport.routeName,
                builder: (context, state) {
                  return const ReceiptVoucherReport();
                }),
          ]),
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: PaymentVoucherInfo.routeName,
                name: PaymentVoucherInfo.routeName,
                builder: (context, state) {
                  return const PaymentVoucherInfo();
                }),
            GoRoute(
                path: PaymentVoucherReportForm.routeName,
                name: PaymentVoucherReportForm.routeName,
                builder: (context, state) {
                  return const PaymentVoucherReportForm();
                }),
            GoRoute(
                path: PaymentVoucherReport.routeName,
                name: PaymentVoucherReport.routeName,
                builder: (context, state) {
                  return const PaymentVoucherReport();
                }),
          ]),
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: DbNotePending.routeName,
                name: DbNotePending.routeName,
                builder: (context, state) {
                  return const DbNotePending();
                }),
            GoRoute(
      ...
      GoRoute(
          ...
          routes: [
            ...
            GoRoute(
                path: CrNotePending.routeName,
                name: CrNotePending.routeName,
                builder: (context, state) {
                  return const CrNotePending();
                }),
          ]),
      GoRoute(
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: ShippingInfo.routeName,
                name: ShippingInfo.routeName,
                builder: (context, state) {
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: CarrierReportForm.routeName,
                name: CarrierReportForm.routeName,
                builder: (context, state) {
                  return const CarrierReportForm();
                }),
            GoRoute(
                path: CarrierInfo.routeName,
                name: CarrierInfo.routeName,
                builder: (context, state) {
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: UnclaimedPayment.routeName,
                name: UnclaimedPayment.routeName,
                builder: (context, state) {
                  return const UnclaimedPayment();
                }),
            GoRoute(
                path: ClaimedPayments.routeName,
                name: ClaimedPayments.routeName,
                builder: (context, state) {
                  return const ClaimedPayments();
                }),
            GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) {
            return AddJournalVoucher(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: JournalVoucherInfo.routeName,
                name: JournalVoucherInfo.routeName,
                builder: (context, state) {
                  return const JournalVoucherInfo();
                }),
            GoRoute(
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: HsnInfo.routeName,
                name: HsnInfo.routeName,
                builder: (context, state) {
                  return const HsnInfo();
                }),
            GoRoute(
      ...
      GoRoute(
          ...
          builder: (context, state) {
            return AddReverseCharge(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: RcmInfo.routeName,
                name: RcmInfo.routeName,
                builder: (context, state) {
                  return const RcmInfo();
                })
          ]),
      GoRoute(
      ...
      GoRoute(
          ...
          routes: [
            GoRoute(
                path: ReverseChargeReport.routeName,
                name: ReverseChargeReport.routeName,
                builder: (context, state) {
                  return const ReverseChargeReport();
                }),
          ]),
      ...
      GoRoute(
          path: AddExportOrder.routeName,
          name: AddExportOrder.routeName,
          builder: (context, state) {
            return AddExportOrder(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: GetExportOrder.routeName,
                name: GetExportOrder.routeName,
                builder: (context, state) {
                  final bool delete = state.extra as bool? ?? false;
                  return GetExportOrder(delete: delete);
                }),
            GoRoute(
                path: ExportOrderReport.routeName,
                name: ExportOrderReport.routeName,
                builder: (context, state) {
                  return const ExportOrderReport();
                })
          ]),
      GoRoute(
          path: LedgerDetailsPage.routeName,
          name: LedgerDetailsPage.routeName,
          builder: (context, state) {
            return LedgerDetailsPage(
                partyCode: state.uri.queryParameters['partyCode'] ?? '');
          }),
      GoRoute(
          path: MasterCodes.routeName,
          name: MasterCodes.routeName,
          builder: (context, state) {
            return const MasterCodes();
          }),
      GoRoute(
          path: StepperForm.routeName,
          name: StepperForm.routeName,
          builder: (context, state) {
            return const StepperForm();
          }),
      GoRoute(
          path: AddFinancialYear.routeName,
          name: AddFinancialYear.routeName,
          builder: (context, state) {
          ...
          routes: [
            GoRoute(
                path: FinancialYearReport.routeName,
                name: FinancialYearReport.routeName,
                builder: (context, state) {
                  return const FinancialYearReport();
                }),
          ]),
      GoRoute(
          path: AddOpening.routeName,
          name: AddOpening.routeName,
          builder: (context, state) {
            return AddOpening(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: OpeningInfo.routeName,
                name: OpeningInfo.routeName,
                builder: (context, state) {
                  return const OpeningInfo();
                }),
            GoRoute(
                path: OpeningReport.routeName,
                name: OpeningReport.routeName,
                builder: (context, state) {
                  return const OpeningReport();
                }),
            GoRoute(
                path: OpeningReportForm.routeName,
                name: OpeningReportForm.routeName,
                builder: (context, state) {
                  return const OpeningReportForm();
                }),
          ]),
      GoRoute(
          path: PaymentAdvanceOutwardPending.routeName,
          name: PaymentAdvanceOutwardPending.routeName,
          builder: (context, state) {
            return const PaymentAdvanceOutwardPending();
          }),
      GoRoute(
          path: AddPaymentOutward.routeName,
          name: AddPaymentOutward.routeName,
          builder: (context, state) {
            return AddPaymentOutward(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: PaymentOutwardFormReport.routeName,
                name: PaymentOutwardFormReport.routeName,
                builder: (context, state) {
                  return const PaymentOutwardFormReport();
                }),
            GoRoute(
                path: PaymentOutwardRep.routeName,
                name: PaymentOutwardRep.routeName,
                builder: (context, state) {
                  return const PaymentOutwardRep();
                }),
            GoRoute(
                path: PaymentOutwardInfo.routeName,
                name: PaymentOutwardInfo.routeName,
                builder: (context, state) {
                  return const PaymentOutwardInfo();
                }),
          ]),
      GoRoute(
          path: AddPaymentId.routeName,
          name: AddPaymentId.routeName,
          builder: (context, state) {
            return AddPaymentId(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: PaymentInFormReport.routeName,
                name: PaymentInFormReport.routeName,
                builder: (context, state) {
                  return const PaymentInFormReport();
                }),
            GoRoute(
                path: PaymentInReport.routeName,
                name: PaymentInReport.routeName,
                builder: (context, state) {
                  return const PaymentInReport();
                }),
            GoRoute(
                path: PaymentInInfo.routeName,
                name: PaymentInInfo.routeName,
                builder: (context, state) {
                  return const PaymentInInfo();
                }),
          ]),
      GoRoute(
          path: PaymentAdvanceInwPending.routeName,
          name: PaymentAdvanceInwPending.routeName,
          builder: (context, state) {
            return const PaymentAdvanceInwPending();
          }),
      GoRoute(
          path: SqlQuery.routeName,
          name: SqlQuery.routeName,
          builder: (context, state) {
            return const SqlQuery();
          },
          routes: [
            GoRoute(
                path: QueryReport.routeName,
                name: QueryReport.routeName,
                builder: (context, state) {
                  return QueryReport(
                      details: state.uri.queryParameters['details'] ?? "");
                }),
      ...
      GoRoute(
          path: AddAcGroup.routeName,
          name: AddAcGroup.routeName,
          builder: (context, state) {
            return AddAcGroup(
                editing: state.uri.queryParameters['editing'] ?? "");
          },
          routes: [
            GoRoute(
                path: AcGroupInfo.routeName,
                name: AcGroupInfo.routeName,
                builder: (context, state) {
                  return const AcGroupInfo();
                }),
            GoRoute(
                path: AcGroupReport.routeName,
                name: AcGroupReport.routeName,
                builder: (context, state) {
                  return const AcGroupReport();
                }),
          ]),
      GoRoute(
          path: SalesOrderNewDetails.routeName,
          name: SalesOrderNewDetails.routeName,
          builder: (context, state) {
            return const SalesOrderNewDetails();
          },
          routes: [
            GoRoute(
                path: SalesOrderNewReportForm.routeName,
                name: SalesOrderNewReportForm.routeName,
                builder: (context, state) {
                  return const SalesOrderNewReportForm();
                }),
            GoRoute(
                path: SalesOrderNewReport.routeName,
                name: SalesOrderNewReport.routeName,
                builder: (context, state) {
                  return const SalesOrderNewReport();
                })
          ]),
      GoRoute(
          path: CreateForm.routeName,
          ...
          routes: [
            GoRoute(
                path: FormReport.routeName,
                name: FormReport.routeName,
                builder: (context, state) {
                  return const FormReport();
                }),
            GoRoute(
                path: UpdateForm.routeName,
                name: UpdateForm.routeName,
                builder: (context, state) {
                  return UpdateForm(
                      details: state.uri.queryParameters['details'] ?? "");
                })
      ...
      GoRoute(
          path: TrialBalanceReportForm.routeName,
          name: TrialBalanceReportForm.routeName,
          builder: (context, state) {
            return const TrialBalanceReportForm();
          },
          routes: [
            GoRoute(
                path: TrialBalanceReport.routeName,
                name: TrialBalanceReport.routeName,
                builder: (context, state) {
                  return const TrialBalanceReport();
                })
          ]),
      GoRoute(
          path: AddOrgCompany.routeName,
          name: AddOrgCompany.routeName,
          builder: (context, state) {
            return const AddOrgCompany();
          }, routes: [
        GoRoute(
            path: AddUser.routeName,
            name: AddUser.routeName,
            builder: (context, state) {
              return const AddUser();
            }),
        GoRoute(
            path: AddCompanyGroup.routeName,
            name: AddCompanyGroup.routeName,
            builder: (context, state) {
              return const AddCompanyGroup();
            }),
        GoRoute(
            path: UpdateUser.routeName,
