...
class AddSaleTransfer extends StatefulWidget {
  static String routeName = "/addSaleTransfer";
  final String details;
  const AddSaleTransfer({super.key, required this.details});

  @override
  State<AddSaleTransfer> createState() => _AddSaleTransferState();
}

class _AddSaleTransferState extends State<AddSaleTransfer> {
  @override
  void initState() {
    super.initState();
    ...
    return Consumer<SaleTransferProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Add Sale Transfer')),
