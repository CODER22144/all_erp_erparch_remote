...
class FinancialCrnotePending extends StatefulWidget {
  static String routeName = "FinancialCrnotePending";

  const FinancialCrnotePending({super.key});

  @override
  State<FinancialCrnotePending> createState() => _FinancialCrnotePendingState();
}

class _FinancialCrnotePendingState extends State<FinancialCrnotePending> {
  @override
  void initState() {
    super.initState();
        ...
        child: SafeArea(
          ...
          appBar: PreferredSize(
              ...
              child: const CommonAppbar(
                  title: 'Financial Credit Note Post Pending')),
                    ...
                    DataTable(
                      ...
                      rows: provider.crNotePostPending.map((data) {
                        return DataRow(cells: [
                          ...
                          DataCell(Align(alignment: Alignment.centerRight,child: Text('${data['TotVal'] ?? ""}'))),
                          DataCell(Align(alignment: Alignment.centerRight,child: Text('${data['adjAmount'] ?? ""}'))),
                          DataCell(Align(alignment: Alignment.centerRight,child: Text('${data['unadjusted'] ?? ""}'))),
                        ]);
                      }).toList(),
                    ),
