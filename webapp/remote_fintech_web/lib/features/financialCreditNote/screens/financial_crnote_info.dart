...
class FinancialCrnoteInfo extends StatefulWidget {
  static String routeName = "financialCrnoteInfo";
  const FinancialCrnoteInfo({super.key});

  @override
  State<FinancialCrnoteInfo> createState() => _FinancialCrnoteInfoState();
}

class _FinancialCrnoteInfoState extends State<FinancialCrnoteInfo> {
  @override
  void initState() {
    super.initState();
