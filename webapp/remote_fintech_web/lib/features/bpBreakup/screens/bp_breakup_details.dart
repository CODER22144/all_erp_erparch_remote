...
import 'bp_breakup_row_fields.dart';

class BpBreakupDetails extends StatefulWidget {
  static String routeName = "bpBreakupDetails";

  const BpBreakupDetails({super.key});
  @override
  BpBreakupDetailsState createState() => BpBreakupDetailsState();
}

class BpBreakupDetailsState extends State<BpBreakupDetails> {
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody['BpBreakupDetails'] = jsonData;
        }
      } else {
    ...
    return Consumer<BpBreakupProvider>(
      ...
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Bp Breakup Details')),
        body: Column(
          children: [
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              http.StreamedResponse result =
                                  await provider.addMaterialAssemblyDetails(
                                      tableRows, manualOrder);
                              var message = jsonDecode(
                                  await result.stream.bytesToString());
                              if (result.statusCode == 200) {
                                context.pushReplacementNamed(
                                    BpBreakupDetails.routeName);
                              } else if (result.statusCode == 400) {
                                networkService.logError({
                                  "errorCode" : message['errorCode'] ?? "",
                                  "errorMsg" : message['message'] ?? "",
                                  "endpoint" : "/add-bp-breakup-details/",
                                  "featureName" : 'BpBreakupDetails'
                                });
                    ...
                    Visibility(
                        ...
                        child: Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri = Uri.parse("https://docs.google.com/spreadsheets/d/1j26WAKJPbbPO736_jqKw34Vh9JR02Z-FMYu8jhbhem4/edit?usp=sharing");
