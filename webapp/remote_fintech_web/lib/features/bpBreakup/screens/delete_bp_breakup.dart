...
class DeleteBpBreakup extends StatefulWidget {
  static String routeName = 'DeleteBpBreakup';
  const DeleteBpBreakup({super.key});

  @override
  State<DeleteBpBreakup> createState() => _DeleteBpBreakupState();
}

class _DeleteBpBreakupState extends State<DeleteBpBreakup> {
  @override
  void initState() {
    super.initState();
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: "Delete BP Breakup")),
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () async {
                              ...
                              http.StreamedResponse response = await networkService
                                  .post("/get-bp-breakup/",
                                  {"bpbId": provider.editController.text});
