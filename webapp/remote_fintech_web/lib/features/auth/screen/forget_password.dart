                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            var request = http.Request(
                                'POST',
                                Uri.parse("${NetworkService.baseUrl}/user/verification/"));
                            request.body = jsonEncode({"email": emailController.text});
                            ...
                            if (result.statusCode == 201) {
                              await showAlertDialog(
                                  context,
                                  "Please find the verification code in your email inbox.",
                                  "Continue",
                                  false);
                              context.pushNamed(UpdatePassword.routeName, queryParameters: {
