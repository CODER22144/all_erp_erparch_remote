...
class AddDlChallanState extends State<AddDlChallan>
  ...
  late DlChallanProvider provider;
    ...
    return Consumer<DlChallanProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: const CommonAppbar(title: 'Add Delivery Challan')),
        body: Center(
          child: Column(
            children: [
              TabBar(
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                //       children: [
                                //         Icon(Icons.arrow_circle_left_sharp, color: Colors.redAccent),
                                //         SizedBox(width: 5),
                                //         Text(
                                //           "Single-Entry",
                                //           style: TextStyle(
                                ...
                                //     ),
                                //     onPressed: () {
                                //       context.pushReplacementNamed(InwardMaster.routeName);
                                //     },
                                //   ),
                                // ),
