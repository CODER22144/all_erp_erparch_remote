...
class DlChallanRowField extends StatefulWidget {
  final int index;
  final List<List<String>> tableRows;
  final Function deleteRow;
  final List<List<TextEditingController>> controllers;
  const DlChallanRowField(
      {super.key,
      required this.index,
  ...
  @override
  State<DlChallanRowField> createState() => _DlChallanRowFieldState();
}

class _DlChallanRowFieldState extends State<DlChallanRowField> {
  @override
