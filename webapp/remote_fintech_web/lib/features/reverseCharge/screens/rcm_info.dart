...
class RcmInfo extends StatefulWidget {
  static String routeName = "RcmInfo";
  const RcmInfo({super.key});

  @override
  State<RcmInfo> createState() => _RcmInfoState();
}

class _RcmInfoState extends State<RcmInfo> {
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'RCM Info')),
