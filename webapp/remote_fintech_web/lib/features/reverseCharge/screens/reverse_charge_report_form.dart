                      ...
                      children: [
                        Padding(
                          ...
                          child: ListView.builder(
                            itemCount: provider.widgetReportList.length,
                            physics: const ClampingScrollPhysics(),
                            scrollDirection: Axis.vertical,
                            shrinkWrap: true,
                            itemBuilder: (context, index) {
                              return provider.widgetReportList[index];
                            },
                          ),
                        ),
                        Visibility(
                          visible: provider.widgetReportList.isNotEmpty,
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(ReverseChargeReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
