...
class AddReverseCharge extends StatefulWidget {
  ...
  const AddReverseCharge({super.key, required this.editing});
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: CommonAppbar(title: widget.editing == 'true' ? 'Update RCM' : 'Add RCM')),
                              ...
                              onPressed: () async {
                                if (formKey.currentState!.validate()) {
                                  ...
                                  await showConfirmationDialogue(
                                      ...
                                      "CANCEL");
                                  if (confirmation) {
                                    http.StreamedResponse result = widget.editing == "true" ? await provider.processUpdateFormInfo() : await provider.processFormInfo();
