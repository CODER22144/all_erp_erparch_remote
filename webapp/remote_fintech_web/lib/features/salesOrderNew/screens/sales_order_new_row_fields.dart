...
class SalesOrderNewRowFields extends StatefulWidget {
  final int index;
  ...
  @override
  State<SalesOrderNewRowFields> createState() => _SalesOrderNewRowFieldsState();
}

class _SalesOrderNewRowFieldsState extends State<SalesOrderNewRowFields> {
  ...
  Future<void> _selectDate(BuildContext context, int index) async {
    ...
    if (pickedDate != null) {
      setState(() {
        ...
        widget.controllers[widget.index][index].text =
          ...
          child: TextFormField(
            ...
            onChanged: (value) async {
              ...
              http.StreamedResponse response =
                  await networkService.get("/get-material/$value/");
              ...
              if (response.statusCode == 200) {
                ...
                setState(() {
                  ...
                  hsnController.selectedItem.value =
                      findDropdownMenuItem(widget.hsnCode, data['hsnCode']);

                  widget.tableRows[widget.index][8] = data['unit'];
                  unitController.selectedItem.value =
                      findDropdownMenuItem(widget.materialUnit, data['unit']);
                  ...
                  widget.controllers[widget.index][11].text =
                      data['gstTaxRate'];
                });
              } else {
            ...
            Padding(
                ...
                child: SearchableDropdown<String>(
                  ...
                  onChanged: (value) async {
                    ...
                    NetworkService networkService = NetworkService();
                    http.StreamedResponse response =
                        await networkService.get("/get-hsn-code/$value/");
                    if (response.statusCode == 200) {
                      widget.controllers[widget.index][11].text =
