...
import 'package:fintech_new_web/features/salesOrderNew/screens/sales_order_new_report.dart';
...
class SalesOrderNewReportForm extends StatefulWidget {
  static String routeName = "SalesOrderNewReportForm";
  const SalesOrderNewReportForm({super.key});

  @override
  State<SalesOrderNewReportForm> createState() => _InwardReportFormState();
}

class _InwardReportFormState extends State<SalesOrderNewReportForm> {
  @override
  void initState() {
    super.initState();
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            context.pushNamed(SalesOrderNewReport.routeName);
                          },
                          child: const Text(
                            'Submit',
                            style: TextStyle(
