...
class AddJournalVoucher extends StatefulWidget {
  static String routeName = "/addJournalVoucher";
  final String? editing;

  const AddJournalVoucher({super.key, this.editing});

  @override
  State<AddJournalVoucher> createState() => _AddJournalVoucherState();
}

class _AddJournalVoucherState extends State<AddJournalVoucher> {
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        final Uri uri = Uri.parse(
                            "https://docs.google.com/spreadsheets/d/1LbfLxhg24noLUklr7mO958fIkZToUsPApWu478MYAFI/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody[JournalVoucherProvider.featureName] =
              jsonData;
        }
      } else {
