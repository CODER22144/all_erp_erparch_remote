...
class LedgerReportForm extends StatefulWidget {
  static String routeName = "LedgerReportForm";
  const LedgerReportForm({super.key});

  @override
  State<LedgerReportForm> createState() =>
      _LedgerReportFormState();
}

class _LedgerReportFormState extends State<LedgerReportForm> {
  @override
  void initState() {
    super.initState();
    LedgerCodesProvider provider =
    Provider.of<LedgerCodesProvider>(context, listen: false);
    provider.initLedgerReport();
  }

  @override
  Widget build(BuildContext context) {
    var formKey = GlobalKey<FormState>();
    return Consumer<LedgerCodesProvider>(
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(LedgerScreens.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
