...
class AddOpening extends StatefulWidget {
  static String routeName = "/addOpening";
  final String? editing;
  const AddOpening({super.key, this.editing});

  @override
  State<AddOpening> createState() => _AddOpeningState();
}
    ...
    return Consumer<OpeningProvider>(builder: (context, provider, child) {
      return Scaffold(
        appBar: PreferredSize(
            ...
            child: CommonAppbar(title: widget.editing != "true" ? 'Add Opening' : "Update Opening")),
                  ...
                  children: [
                    Visibility(
                      ...
                      child: ImportWidget(
                          ...
                          feature: OpeningProvider.featureName,
                          sampleFileUrl: "https://docs.google.com/spreadsheets/d/1CrXDy_xxd51-uXNQaIIo-mXvgWuttUOymrGGd6EIqKM/edit?usp=sharing",
                          isMaster: true,
                              ...
                              if (confirmation) {
                                ...
                                if (result.statusCode == 200) {
                                  if(widget.editing == "true") {
                                    ...
                                    context.pushReplacementNamed(AddOpening.routeName);
                                  }
