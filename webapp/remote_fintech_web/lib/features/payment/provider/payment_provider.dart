...
class PaymentProvider with ChangeNotifier {
  ...
  void initReport() async {
    ...
    String jsonData =
        '[{"id":"lcode","name":"Party Code","isMandatory":false,"inputType":"dropdown","dropdownMenuItem":"/get-ledger-codes/"},{"id":"iday","name":"Days","isMandatory":false,"inputType":"number","default":0}]';
  ...
  void getBillRows() {
    ...
    for(var data in billPending['LcodeData']) {
      billRows.add(DataRow(cells: [
      ...
      for(var details in data['details']) {
        billRows.add(DataRow(cells: [
          ...
          DataCell(Align(alignment: Alignment.centerRight,child: Text(parseDoubleUpto2Decimal('${details['tdsAmount']}')))),
      ...
      billRows.add(emptyRow);
    }
    var grandTotal = jsonDecode(billPending['GrandSummary']);
