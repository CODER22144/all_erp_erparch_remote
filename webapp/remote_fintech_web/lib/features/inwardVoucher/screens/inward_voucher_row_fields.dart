...
class InwardVoucherRowFields extends StatefulWidget {
  final int index;
  ...
  @override
  State<InwardVoucherRowFields> createState() => _InwardVoucherRowFieldsState();
}

class _InwardVoucherRowFieldsState extends State<InwardVoucherRowFields> {
