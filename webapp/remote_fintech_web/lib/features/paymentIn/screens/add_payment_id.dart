...
class AddPaymentId extends StatefulWidget {
  static String routeName = "/AddPaymentId";
  final String? editing;

  const AddPaymentId({super.key, this.editing});

  @override
  State<AddPaymentId> createState() => _AddPaymentIdState();
}

class _AddPaymentIdState extends State<AddPaymentId> {
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              final Uri uri = Uri.parse(
                                  "https://docs.google.com/spreadsheets/d/1xldZJOU3sxmL9GdakH6Wkw__dJwO-mIpG-mzyEDvtdU/edit?usp=sharing");
    ...
    try {
      ...
      if (result != null) {
        ...
        if (sheet != null) {
          ...
          GlobalVariables.requestBody[PaymentInProvider.featureName] = {};
          GlobalVariables.requestBody[PaymentInProvider.featureName] =
              jsonData;
        }
      } else {
