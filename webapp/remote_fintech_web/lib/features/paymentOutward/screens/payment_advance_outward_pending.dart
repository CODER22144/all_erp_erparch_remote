...
class PaymentAdvanceOutwardPending extends StatefulWidget {
  static String routeName = "/paymentAdvanceOutwardPending";

  const PaymentAdvanceOutwardPending({super.key});

  @override
  State<PaymentAdvanceOutwardPending> createState() =>
      _PaymentAdvanceOutwardPendingState();
}

class _PaymentAdvanceOutwardPendingState
    extends State<PaymentAdvanceOutwardPending> {
  @override
  void initState() {
    super.initState();
    PaymentOutwardProvider provider =
        Provider.of<PaymentOutwardProvider>(context, listen: false);
    provider.getPendingPaymentOutAdvance();
  }
      ...
      return Material(
        child: SafeArea(
          ...
          appBar: PreferredSize(
              ...
              child: const CommonAppbar(title: 'Payment Outward Advance Post')),
                ...
                child: Column(
                  ...
                  children: [
                    DataTable(
                      ...
                      rows: provider.paymentOutAdvance.map((data) {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        ...
                        if (confirmation) {
                          ...
                          await provider.addPaymentOutwardClear();
                          var message =
