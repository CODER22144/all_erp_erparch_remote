...
class CrNoteReportForm extends StatefulWidget {
  static String routeName = "CrNoteReportForm";
  const CrNoteReportForm({super.key});

  @override
  State<CrNoteReportForm> createState() =>
      _CrNoteReportFormState();
}

class _CrNoteReportFormState extends State<CrNoteReportForm> {
  @override
  void initState() {
    super.initState();
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(CreditNoteReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
