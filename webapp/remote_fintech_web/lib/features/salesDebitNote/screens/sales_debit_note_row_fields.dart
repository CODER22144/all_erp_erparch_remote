...
class SalesDebitNoteRowFields extends StatefulWidget {
  final int index;
  ...
  @override
  State<SalesDebitNoteRowFields> createState() =>
      _SalesDebitNoteRowFieldsState();
}

class _SalesDebitNoteRowFieldsState extends State<SalesDebitNoteRowFields> {
