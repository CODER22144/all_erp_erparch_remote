...
class BankReportForm extends StatefulWidget {
  static String routeName = "BankReportForm";
  const BankReportForm({super.key});

  @override
  State<BankReportForm> createState() => _BankReportFormState();
}

class _BankReportFormState extends State<BankReportForm> {
  @override
  void initState() {
    super.initState();
                    ...
                    Visibility(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () async {
                            context.pushNamed(BankReport.routeName);
                          },
                          child: const Text(
                            'Submit',
                            style: TextStyle(
