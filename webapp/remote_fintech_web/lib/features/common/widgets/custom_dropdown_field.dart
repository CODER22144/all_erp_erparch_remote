...
class _CustomDropdownFieldState extends State<CustomDropdownField> {
  ...
  void initState() {
    ...
    if(widget.field.controller is SearchableDropdownController && checkForEmptyOrNullString(widget.field.defaultValue)) {
      widget.field.controller.selectedItem.value = searchItem;
    }
  }
