...
class SalesOrderProvider with ChangeNotifier {
  ...
  void initWidget() async {
    ...
    widgetList.clear();
    String jsonData =
        '[{"id":"lcode","name":"Ledger Code","isMandatory":true,"inputType":"dropdown","dropdownMenuItem":"/get-ledger-codes/"},{"id":"curCode","name":"Currency Code","isMandatory":false,"inputType":"dropdown","dropdownMenuItem":"/get-currency/","default":"INR"},{"id":"conRate","name":"Conversion Rate","isMandatory":true,"inputType":"number","default":1},{"id":"orderId","name":"Order ID","isMandatory":false,"inputType":"number"},{"id":"poNo","name":"PO No.","isMandatory":false,"inputType":"text","maxCharacter":30},{"id":"poDate","name":"PO Date","isMandatory":false,"inputType":"datetime"},{"id":"privateMark","name":"Private Mark","isMandatory":false,"inputType":"text","maxCharacter":20},{"id":"shipId","name":"Ship ID","isMandatory":false,"inputType":"dropdown","dropdownMenuItem":"/get-ship/"}]';
    ...
    for (var element in jsonDecode(jsonData)) {
      ...
      formFieldDetails.add(FormUI(
          ...
          defaultValue: GlobalVariables.requestBody[featureName].isNotEmpty
              ? GlobalVariables.requestBody[featureName][element['id']]
              : element['default'],
  ...
  Future<http.StreamedResponse> processFormInfo(
      List<Map<String, dynamic>> orderDetails, bool isManual) async {
    if (isManual) {
