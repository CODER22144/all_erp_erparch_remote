...
import '../provider/receipt_voucher_provider.dart';

class ReceiptVoucherInfo extends StatefulWidget {
  static String routeName = "ReceiptVoucherInfo";
  const ReceiptVoucherInfo({super.key});

  @override
  State<ReceiptVoucherInfo> createState() => _ReceiptVoucherInfoState();
}

class _ReceiptVoucherInfoState extends State<ReceiptVoucherInfo> {
  @override
  void initState() {
    super.initState();
        ...
        builder: (context, provider, child) {
          return Scaffold(
            appBar: PreferredSize(
                ...
                child: const CommonAppbar(title: 'Receipt Voucher Info')),
