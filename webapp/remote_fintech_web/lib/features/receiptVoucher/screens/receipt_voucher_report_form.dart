...
import 'package:fintech_new_web/features/receiptVoucher/screens/receipt_voucher_report.dart';
...
class ReceiptVoucherReportForm extends StatefulWidget {
  static String routeName = "ReceiptVoucherReportForm";
  const ReceiptVoucherReportForm({super.key});

  @override
  State<ReceiptVoucherReportForm> createState() =>
      _ReceiptVoucherReportFormState();
}

class _ReceiptVoucherReportFormState extends State<ReceiptVoucherReportForm> {
  @override
  void initState() {
    super.initState();
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(ReceiptVoucherReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
