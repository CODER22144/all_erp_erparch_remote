...
class Camera {
  ...
  Future<String> uploadDocuments(String blobPath, String name, String endpoint, String uk) async {
    SharedPreferences prefs =
    await SharedPreferences.getInstance();
    var token = prefs.getString("auth_token");
    var headers = {'Content-Type': 'application/x-www-form-urlencoded', "Authorization": "Bearer $token"};
    var request = http.MultipartRequest(
        'POST', Uri.parse('${NetworkService.baseUrl}$endpoint'));
  ...
  Future<XFile?> chooseFile(context) async {
    XFile? imagePath;
    imagePath = await getImage('gallery');
    return imagePath;
  }
