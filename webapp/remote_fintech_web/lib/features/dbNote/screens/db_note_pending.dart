...
class DbNotePending extends StatefulWidget {
  static String routeName = "DbNotePending";

  const DbNotePending({super.key});

  @override
  State<DbNotePending> createState() => _DbNotePendingState();
}

class _DbNotePendingState extends State<DbNotePending> {
  @override
  void initState() {
    super.initState();
    DbNoteProvider provider =
        Provider.of<DbNoteProvider>(context, listen: false);
    provider.getDbNotePostPending();
  }
      ...
      return Material(
        child: SafeArea(
          ...
          appBar: PreferredSize(
              ...
              child: const CommonAppbar(title: 'Debit Note Post Pending')),
                ...
                child: Column(
                  ...
                  children: [
                    DataTable(
                      ...
                      rows: provider.dbNotePostPending.map((data) {
