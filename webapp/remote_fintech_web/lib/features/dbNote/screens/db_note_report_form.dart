...
class DbNoteReportForm extends StatefulWidget {
  static String routeName = "DbNoteReportForm";
  const DbNoteReportForm({super.key});

  @override
  State<DbNoteReportForm> createState() =>
      _DbNoteReportFormState();
}

class _DbNoteReportFormState extends State<DbNoteReportForm> {
  @override
  void initState() {
    super.initState();
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: ElevatedButton(
                              ...
                              onPressed: () async {
                                context.pushNamed(DbNoteReport.routeName);
                              },
                              child: const Text(
                                'Submit',
                                style: TextStyle(
