...
from .views import yearly_sales_report_view as ysrv


urlpatterns = [

    re_path(r"^yearly-sales-report/$", ysrv.getYearlySalesReport),
    re_path(r"^yearly-category-sales-report/$", ysrv.getYearlyCategorySalesReport),

    re_path(r"^menu/$", menu_view.getMenu),

    re_path(r"^pb-cost-mat-source/$", wsr.getPbCostingMaterialSource),
    re_path(r"^mat-assembly-comparison/$", wsr.getMaterialAssemblyComparison),
    ...
    re_path(r"^mat-min-max-report/$", matsv.getMaterialReOrderReport),
    re_path(r"^stock-value-report/$", matsv.getMaterialStockValue),
    ...
    re_path(r"^wire-size-mat-rep/$", wsr.getWireSizeMaterial),
    re_path(r"^ws-assembly/$", wsr.getWireSizeAssemblyReportFormat),
    ...
    re_path(r"^old-wire-size/$", wsr.getOldWireSizeReport),
    re_path(r"^ws-mat-det/$", wsr.wsReportForTLWithWireSizeNo),
