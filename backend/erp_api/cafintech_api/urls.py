...
from .views import upload_drawings as updv
from .views import material_classification_view as mcv


urlpatterns = [

    # Material Classification
    re_path(r"^add-material-classification/$", mcv.addMaterialClassification),
    re_path(r"^update-material-classification/$", mcv.updateMaterialClassification),
    re_path(r"^get-category/$", mcv.getCategory),
    re_path(r"^get-sub-category/$", mcv.getSubCategory),
    re_path(r"^material-classification-report/$", mcv.getMaterialClassificationReport),
    # re_path(r"^get-brands/$", mcv.getBrands),
    # re_path(r"^get-departments/$", mcv.getDepartments),
    # re_path(r"^get-product-segment/$", mcv.getProductSegment),
    # re_path(r"^get-product-group/$", mcv.getProductGroup),



    # Home
    re_path(r"^upload-drw/$", updv.FileUploadView.as_view()),
   ...
   # GR QTY CLEAR
    ...
    re_path(r"^old-ws-exp/$", wsv.getOldWireSize),
    ...
    re_path(r"^pb-cost-comparison/$", pbuv.productBreakupCostComparison),
    ...
    re_path(r"^qc-pending/$", misv.getQcPendings),
    re_path(r"^add-inc/$", misv.addIcoming),
    re_path(r"^inc-report/$", misv.incomingReport),
    ...
    # Job Work Out
    re_path(r"^get-jw-clear-report/$", jwov.getJobWorkOutClearReport),
    re_path(r"^get-jw-clear-pending/$", jwov.getJobWorkOutClearPending),
    re_path(r"^delete-jw-clear/$", jwov.deleteJobWorkOutClear),
    re_path(r"^add-jw-clear/$", jwov.createJobWorkOutClear),
    ...
    re_path(r'^edit-bp-ob-material-bulk/$', bpobmv.bulkUpdateBusinessPartnerObMaterial),
    ...
    re_path(r'^get-bp-breakup-summary/$', bpbreakv.getBpBreakupSummary),
    ...
    re_path(r'^bp-processing-report/$', bppv.getBpProcessingReport),
