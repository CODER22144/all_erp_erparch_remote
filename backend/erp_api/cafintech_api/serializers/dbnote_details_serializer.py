...
class DbNoteDetailSerializer(serializers.Serializer):
    ...
    vtype = serializers.CharField(max_length=100, allow_null=True, required = False,allow_blank=True)
    wdocno = serializers.CharField(max_length=100, allow_null=True, required = False,allow_blank=True)
    stockLess = serializers.CharField(max_length=1, default='N')
