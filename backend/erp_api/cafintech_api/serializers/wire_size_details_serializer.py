...
class WireSizeDetailSerializer(serializers.Serializer):
    ...
    assno = serializers.CharField(max_length=15)
    remark = serializers.CharField(max_length=50, allow_null=True, required=False)
    partType = serializers.CharField(max_length=1, allow_null=True, required=False)
